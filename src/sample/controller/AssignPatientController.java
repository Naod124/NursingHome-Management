...
public class AssignPatientController implements Initializable {
	...
	void assign(ActionEvent event) throws SQLException {
		...
		pq.AssignNursetoPatient(ssntextfield.getText(), freetime.getValue(), String.valueOf(nurseSSN));
	...
	void fectchdata(MouseEvent event) throws SQLException {
		...
		// casting that object to patient table to access the different information or data
		...
		// getting the free time of patient from database and spliting with respect to comma

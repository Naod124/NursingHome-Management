...
public class PatientQueries {
	...
	public void AssignNursetoPatient(String PatientSSN, String time, String nurseSSN) throws SQLException {
		connection = DriverManager.getConnection("jdbc:mysql://den1.mysql3.gear.host:3306/nursinghome", "nursinghome",
				"Vw3J!60l-0kd");
		String updateQuery = "INSERT INTO timetable(appointed_time, occupiedby, patientid) VALUES(?,?,?);";
		pstmt = connection.prepareStatement(updateQuery);
